...
public:
    ...
    void setupUi(QWidget *MyForm)
    {
        ...
        QObject::connect(radioButton, SIGNAL(clicked()), widget, SLOT(canviarCamera()));
        QObject::connect(radioButton_2, SIGNAL(clicked()), widget, SLOT(canviaLegoMan()));
    ...
    void retranslateUi(QWidget *MyForm)
    {
        ...
        radioButton->setText(QApplication::translate("MyForm", "Ortogonal", 0));
