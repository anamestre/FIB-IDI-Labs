...
void MyGLWidget::carregaShaders()
{
  ...
  fs.compileSourceFile("E:/Documents/EXAMEN IDI/versio neta/sessio5/ex2/shaders/fragshad.frag");
  vs.compileSourceFile("E:/Documents/EXAMEN IDI/versio neta/sessio5/ex2/shaders/vertshad.vert");
  // Creem el program
...
void MyGLWidget::calculaCentreRadi(){
    centre = glm::vec3((modelMaxim.x + modelMinim.x)/2, modelMinim.y, (modelMaxim.z + modelMinim.z)/2);
