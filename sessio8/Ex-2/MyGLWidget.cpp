...
void MyGLWidget::initializeGL ()
{
  ...
  coord_x_luz = 1.0;
  posLuz();
  colLuz(); //lo de los uniforms y el color y la posicion de la luz blabla
  createBuffers();
  projectTransform ();
  viewTransform ();
}
...
void MyGLWidget::createBuffers ()
{
  ...
  patr.load("C:/Users/Carlos/Desktop/IDI3/IDI/models/Patricio.obj");
...
void MyGLWidget::carregaShaders()
{
  ...
  fs.compileSourceFile("C:/Users/Carlos/Desktop/IDI3/IDI/bloc-3/S8/Ex-2/shaders/fragshad.frag");
  vs.compileSourceFile("C:/Users/Carlos/Desktop/IDI3/IDI/bloc-3/S8/Ex-2/shaders/vertshad.vert");
  // Creem el program
...
void MyGLWidget::posLuz() {
    focusPos = glm::vec3(coord_x_luz,1,1);
    glUniform3fv(posLoc, 1, &focusPos[0]);
}

void MyGLWidget::colLuz() {
    focusCol = glm::vec3(0.8,0.8,0.8);
    glUniform3fv(colLoc,1, &focusCol[0]);
}
