...
void MyGLWidget::carregaShaders()
{
  ...
  fs.compileSourceFile("E:/Documents/EXAMEN IDI/versio neta/ex2/shaders/fragshad.frag");
  vs.compileSourceFile("E:/Documents/EXAMEN IDI/versio neta/ex2/shaders/vertshad.vert");
  // Creem el program
