...
void MyGLWidget::carregaShaders()
{
  ...
  fs.compileSourceFile("E:/Documents/EXAMEN IDI/versio neta/ex6/shaders/fragshad.frag");
  vs.compileSourceFile("E:/Documents/EXAMEN IDI/versio neta/ex6/shaders/vertshad.vert");
  // Creem el program
...
void MyGLWidget::carregarModel(){
    homer.load("E:/Documents/EXAMEN IDI/versio neta/ex6/models/HomerProves.obj");
