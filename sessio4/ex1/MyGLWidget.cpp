...
void MyGLWidget::carregaShaders()
{
  ...
  fs.compileSourceFile("E:/Documents/EXAMEN IDI/versio neta/s4/shaders/fragshad.frag");
  vs.compileSourceFile("E:/Documents/EXAMEN IDI/versio neta/s4/shaders/vertshad.vert");
  // Creem el program
