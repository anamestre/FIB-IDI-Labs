...
class MyGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core 
{
  ...
  private:
    ...
    glm::vec3 escenaMaxim, escenaMinim, centreEscena, centreVaca, VRP;

    GLuint VAO_Vaca, VBO_VacaPos, VBO_VacaNorm, VBO_VacaMatamb, VBO_VacaMatdiff, VBO_VacaMatspec, VBO_VacaMatshin;
    GLuint teclaXLoc, teclaLloc;

    float FOV, zNear, zFar, ra, angleX, FOVi, escalaVaca, rotacio;
    ...
    public slots:
        void aplicarZoom(int slider);

    signals:
        void actualitzaBarra(int slider);
